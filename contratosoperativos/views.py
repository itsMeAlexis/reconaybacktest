...
def generate_PDF_OperativoFIN(request, contratoOperativo_id):
    ...
    imagen_path = "finanzas.jpg"
    
    
    data = [
            Image(imagen_path, width=100, height=100),
            ...
            Paragraph( f"&nbsp;&nbsp;{contratoOperativo.nombreSecretaria.upper()}&nbsp;&nbsp;" , left_aligned_style)],

             [Paragraph("<b>NOMBRE PRESTADOR DE SERVICIO:</b>", left_aligned_style),           
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.nombrePdS.upper()}&nbsp;&nbsp;", left_aligned_style),],         

            [Paragraph("<b>TELÉFONO:</b>", left_aligned_style),            
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.telefonoPdS.upper()}&nbsp;&nbsp;", left_aligned_style),
            Paragraph("<b>NO DE CONTRATO:</b>", left_aligned_style),            
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.noContrato}&nbsp;&nbsp;", left_aligned_style),],

            [Paragraph("<b>SERVICIO REQUERIDO:</b>", left_aligned_style),           
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.funcionesPsD.upper()}&nbsp;&nbsp;", left_aligned_style),],   

            [Paragraph("<b>ÁREA EN LA QUE SE REQUIEREN LOS SERVICIOS:</b>", left_aligned_style),           
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.puestoSolicitante.upper()}&nbsp;&nbsp;", left_aligned_style)],         

            [Paragraph("<b>DOMICILIO DE LA DEPENDENCIA:</b>", left_aligned_style),           
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.domicilioSecretaria.upper()}&nbsp;&nbsp;", left_aligned_style)],

            [Paragraph("<b>TITULAR DEL ÁREA:</b>", left_aligned_style),            
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.nombreSolicitante.upper()}&nbsp;&nbsp;", left_aligned_style)],     
            ...
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.tipoContrato.upper()}&nbsp;&nbsp;", left_aligned_style)],

            [Paragraph("<b>FECHA INICIAL:</b>", left_aligned_style),            
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.fechaInicioContrato.upper()}&nbsp;&nbsp;", left_aligned_style),
            Paragraph("<b>FECHA DE TERMINACIÓN:</b>", left_aligned_style),            
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.fechaFinContrato.upper()}&nbsp;&nbsp;", left_aligned_style)
            ],           

            [Paragraph("<b>PERCEPCIÓN MENSUAL NETA:</b>", left_aligned_style),            
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.impMensualBruto}&nbsp;&nbsp;", left_aligned_style),
            Paragraph("<b>PERCEPCIÓN MENSUAL NETA CON LETRA:</b>", left_aligned_style),            
            Paragraph(f"{contratoOperativo.montoLetra}&nbsp;&nbsp;", left_aligned_style),
            ],

            [Paragraph("<b>AJUSTE DE SUELDO:</b>", left_aligned_style),            
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.sueldoAnterior}&nbsp;&nbsp;", left_aligned_style),
            Paragraph("<b>AJUSTE DE SUELDO CON LETRA:</b>", left_aligned_style),            
            Paragraph(f"{contratoOperativo.montoLetraAnterior.upper()}&nbsp;&nbsp;", left_aligned_style),],            
            ...
            [Paragraph(f"&nbsp;&nbsp;{contratoOperativo.nombreSolicitante.upper()}&nbsp;&nbsp;", centered_style),
             Paragraph("<br/><br/><br/>", centered_style),
            Paragraph(f"&nbsp;&nbsp;{contratoOperativo.nombreSecretario.upper()}&nbsp;&nbsp;", centered_style)],

            [Paragraph("<b>" + f"&nbsp;&nbsp;{contratoOperativo.puestoSolicitante.upper()}&nbsp;&nbsp;" + " </b>", centered_style),
            Paragraph("<br/><br/><br/>", centered_style),
            Paragraph("<b>" + f"&nbsp;&nbsp;{contratoOperativo.puestoSecretario.upper()}&nbsp;&nbsp;" + " </b>", centered_style)
            ],
            ...
            [Paragraph(f"&nbsp;&nbsp;{contratoOperativo.nombreVobo.upper()}&nbsp;&nbsp;", centered_style)], 

            [Paragraph("<b>" + f"&nbsp;&nbsp;{contratoOperativo.puestoVobo.upper()}&nbsp;&nbsp;" + " </b>", centered_style)],   
